    ...
    return(
        <div className = "center">
            ...
            <div> 
                ...
                <div className = "row">
                <div style = {{display: 'flex',flexDirection: 'column',alignItems: 'center', width: '70vw', height: '70vh', backgroundColor = "#c084fc00",backgroundColor = "#c084fc00", }} className = "title_details">
