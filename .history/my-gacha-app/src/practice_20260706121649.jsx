            ...
            <>
                ...
                {mode == "learn" && <div> 
                    {item.flashcardData &&
                            <>
                                <div>
                                    <button className = "flashcard"onClick = {() => {setButtonText(prev => !prev)}}>{buttonText? `Term: ${item.flashcardData[index].term}`: `Definition: ${item.flashcardData[index].definition}` }</button>
                                </div>
                            </>
                    }
