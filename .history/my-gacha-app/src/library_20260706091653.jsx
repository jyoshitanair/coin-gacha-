...
export default function Library({uuid}) {
    ...
    useEffect(() => {
        ...
        if (data){
            const updated = data.map((pull) => {
                pull2 = {...pull}
                if(pull2.title.length > 13){
                pull2.title = pull2.title.slice(0, 13) + "...";
                }
                if(pull2.description.length > 13){
                    pull2.description = pull2.description.slice(0, 13) + "..."
                }
            })
            setPulls(updated)
        }
