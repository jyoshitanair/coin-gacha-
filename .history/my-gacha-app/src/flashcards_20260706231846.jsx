...
export default function Flashcards({uuid}) {
    ...
    <>
        {page == "flashcards" && <div className = "center">
            ...
            <p className = "smallp"> here you can create your own flashcards and play them! there are 2 modes learn and test. in learn you don't gain any coins and you are more or less just looking through the terms - nothing to lose. In test mode for every question you get right you get</p>
