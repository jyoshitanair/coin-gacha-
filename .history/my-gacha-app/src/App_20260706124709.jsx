...
function App() {
  ...
  return (
    <>
      ...
      <div style={{ marginTop: '40px', width: '100vw', height: '100vh', flexDirection: 'coldisplay: 'flex', gap: '80px' }}>
        <p> First, you're going to need to get some coins!  </p>
        <p> You can get these by heading over to the flashcards tab </p>
        <p> For every question that you get right on your flashcards that you make</p>
      </div>
