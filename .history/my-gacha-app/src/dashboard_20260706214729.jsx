...
export default function Dashboard() {
    ...
    return(
        ...
        {page == "dashboard" && 
            ...
            <div style = {{gap: '30px', display: 'flex', alignItems: 'center', flexDirection: 'column', pointerEvents: 'none'}}>
                <button style = {{paddingLeft: '40px'}} className = "buttons_normal" disabled = {processing} onClick = {() => setPage("flashcards")}> Flashcards </button>
                <p className = "mediump"> (to answer questions and get more money!)</p>
            </div>
            <div style = {{gap: '30px', display: 'flex', alignItems: 'center', flexDirection: 'column', pointerEvents: 'none'}}>
                <button style = {{paddingLeft: '40px'}} className = "accent_button" disabled = {processing} onClick={() => Logout()}> Logout</button>
