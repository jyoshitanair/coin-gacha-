...
export default function Flashcards({uuid}) {
    ...
    <>
        {page == "flashcards" && <div className = "center">
            ...
            <p style = {{ maxWidth: '70vw',width: '100%', fontSize: '25px'}} className = "mediump_normal"> here you can create your own flashcards and play them! there are 2 modes learn and test</p>
