        ...
        <>
            ...
            {page == "library" && loading == false &&
                <div className = "center">
                    <Toaster/>
                    <h1 className = "maintext" > Library</h1>
                    <div style = {{ display: 'flex', flexDirection: 'row', gap: '50px', alignItems: 'center'}}>
                        ...
                        <button 
                            disabled = {processing}
                            className = "accent_button buttons_normal" 
                    ...
                    <div className = "grid_container">
                        {currentPulls && currentPulls.map((pull) => (
                            <div  key = {pull.id} className = "grid_item2">
                                    <p className = "crop smallp">Title: {pull.title}</p>
                                    <p className = "crop smallp">Description: {pull.description}</p>
