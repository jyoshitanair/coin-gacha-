...
export default function Library({item}) {
    ...
    const [loading, setIndex] = useState(0
    ...
    return(
        <div>
            ...
            {mode == "test" && <div>
                ...
                <button disabled = {index == item.flashcardData.length - 1} onClick = {() => {correct}}> correct</button>
                <button disabled = {index == item.flashcardData.length - 1} onClick = {() => {setIndex(prev => (Math.min(item.flashcardData.length-1,prev +1)))}}> wrong</button>
