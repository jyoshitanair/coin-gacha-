...
export default function Flashcards({uuid}) {
    ...
    <>
        {page == "flashcards" && <div className = "center">
            <Toaster/>
            <h1 style = {{marginBottom: '90px', width: '100%'}} className = "maintext"> Flashcards </h1>
            <p style = {{ maxWidth: '70vw', padding: '0px',width: '100%'}} className = "mediump_normal"> here you can create your own flashcards and play them! there are 2 modes learn and test. in learn you don't gain any coins and you are more or less just looking through the terms - nothing to lose. In test mode for every question you get right you get 1 coin and you lose 1 coin for every question you get wrong!</p>
            <p style = {{maxWidth: '20vw', padding: '0px'}} className = "otherp"> Total Coins : {coins}</p>
