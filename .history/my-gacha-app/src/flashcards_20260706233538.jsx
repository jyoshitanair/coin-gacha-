...
export default function Flashcards({uuid}) {
    ...
    <>
        {page == "flashcards" && <div className = "center">
            ...
            <p style = {{ maxWidth: '70vw',width: '100%'}} className = "mediump_normal"> <strong> <em> learn: </em></strong>learn:  you don't gain any coins and you are more or less just looking through the terms - nothing to lose.</p>
            <p style = {{ maxWidth: '70vw',width: '100%'}} className = "mediump_normal"> test: for every question you get right you get 1 coin and you lose 1 coin for every question you get wrong! don't worry, you can't go below zero though!</p>
