  ...
  return (
    <>
      ...
      <div className = "patcher">  
        ...
        <p> i need you to get the questions on the flashcards right </p>
        <p> so that i can get </p>
        <img className = "patch" src = {sadcat}/>
      </div>
      <div className = "patcher">
        <p> that's when you come in  </p>
        <p> help me get the questions right in the flashcards tab </p>
        <p> then i can finally get enough money to gamble again!</p>
        <img className = "patchotherway" src = {sparklecat}/>
      </div>
      <div className = "patcher">
        <p> every time we get 10 coins we can ~ ฅ^-⩊-^ ฅ  </p>
