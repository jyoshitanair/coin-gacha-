...
export default function Login() {
    ...
    return (
        <>
            ...
            <div className = "patcher" style = {{height: 'auto',marginTop: '-500px'}}>
                <h1 className = "maintext" > login page</h1>
                <img style = {{height: '300px',position: 'absolute', width: '300px', objectFit: 'cover', marginTop: '0px'}} className = "patch" src = {sparklecat}/>
            </div>
