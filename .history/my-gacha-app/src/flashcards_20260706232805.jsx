...
export default function Flashcards({uuid}) {
    ...
    <>
        {page == "flashcards" && <div className = "center">
            ...
            <p style = {{ maxWidth: '70vw',width: '100%'}} className = "mediump_normal"> learn:  you don't gain any coins and you are more or less just looking through the terms - nothing to lose.</p>
