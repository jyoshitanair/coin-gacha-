...
export default function Flashcards({uuid}) {
    ...
    <>
        {page == "flashcards" && <div className = "center">
            ...
            <p style = {{ maxWidth: '70vw',width: '100%'}} className = "mediump_normal"> here you can create your own flashcards and play them! there are 2 modes learn and test</p>
            <p style = {{ maxWidth: '70vw',width: '100%'}} className = "mediump_normal"> learn:  you don't gain any coins and you are more or less just looking through the terms - nothing to lose. In test mode for every question you get right you get 1 coin and you lose 1 coin for every question you get wrong!</p>
            <p style = {{ maxWidth: '70vw',width: '100%'}} className = "mediump_normal"> nothing to lose. In test mode for every question you get right you get 1 coin and you lose 1 coin for every question you get wrong!</p>
