...
export default function Flashcards({uuid}) {
    ...
    <>
        {page == "flashcards" && <div className = "center">
            <Toaster/>
            <h1 style = {{marginBottom: '90px', marginBottom: '90px'}} className = "maintext"> Flashcards </h1>
            <p className = "mediump_normal"> here you can create your own flashcards and play them! there are 2 modes learn and test. in learn you don't gain any coins and you are more or less just looking through the terms - nothing to lose. In test mode for every question you get right you get 1 coin and you lose 1 coin for every question you get wrong!</p>
