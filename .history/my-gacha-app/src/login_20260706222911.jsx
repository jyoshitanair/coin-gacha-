    ...
    return (
        <>
            ...
            <div className = "patcher" style = {{height: 'auto', paddingBottom: '50px'}}>
                <h1 style = {{height: 'auto', paddingBottom: '50px'}}className = "maintext" > login </h1>
                <img style = {{height: '300px',position: 'absolute', width: '300px', objectFit: 'cover', marginTop: '0'}} className = "patch" src = {sparklecat}/>
            </div>
