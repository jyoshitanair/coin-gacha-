  ...
  return (
    <>
      ...
      <div className = "patcher">
        ...
        <p> I'm <span style = {{fontFamily: 'mono', fontWeight: 'bold', color: '#ffffff'}}> Patch </span> and you're here to get me out of my gambling debt. </p>
        <p> meow~ /ᐠ - ˕ -マ </p>
        <img className = "patchotherway" src = {wavecat}/>
      </div>
      <div className = "patcher">
        <p>  </p>
        <p> for every question you get right i get money to gamble</p>
        <p> that's where you come in! for every question you get right i get money to gamble!</p>
