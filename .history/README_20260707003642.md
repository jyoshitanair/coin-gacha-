...
#### Quick Overview
---
We all love to gamble. yeah WE okay... but for one sad kitty named patch the debts have caught up to them. now its up to you to help them get 
their money back....so that they can go gambling again! Help patch answer questions so that they can win who wants to be a meowlionaire and get
their gambling life back! it features a study app where you can make flashcards to study and a gambling section.
...
* then you will go to your dashboard! there click on flashcards
* now you need to create a new flashcard set and study it in learn mode
* once you are ready click on the test mode and get questions right to get money!
* once you have 10 coins go back to the gambling tab and gamble your earnings away.
...
5) Features four tables to track the gacha pulls, user's coin count, the users, and the flashcards!
...
4) **the css...** shiver. i hate css. i spent so long trying to just align everything and had to scrap classes countless times leading to other stuff getting affected and i had to reformat EVERYTHING T-T . 
